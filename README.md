...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/crowsetta-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14920&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/crowsetta-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `crowsetta` can be installed with:

```
conda install crowsetta
```

It is possible to list all of the versions of `crowsetta` available on your platform with:
